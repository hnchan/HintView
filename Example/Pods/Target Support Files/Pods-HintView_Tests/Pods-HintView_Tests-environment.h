...
// HintView
#define COCOAPODS_POD_AVAILABLE_HintView
#define COCOAPODS_VERSION_MAJOR_HintView 0
#define COCOAPODS_VERSION_MINOR_HintView 1
#define COCOAPODS_VERSION_PATCH_HintView 0
